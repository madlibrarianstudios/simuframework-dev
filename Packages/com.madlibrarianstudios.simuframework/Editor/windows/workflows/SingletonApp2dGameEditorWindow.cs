...
public class SingletonApp2dGameEditorWindow : EditorWindow
{
    ...
    private void Draw2dSingletonInfrastructureOptions()
    {
        ...
        EditorGUILayout.LabelField("4. Design Level content for gameplay (SEPERATE WORKFLOW)", EditorStyles.boldLabel);
        ...
        #endregion
        #region 5 camera and ui
        EditorGUILayout.LabelField("5. configure camera and ui", EditorStyles.boldLabel);
        EditorGUILayout.LabelField("-add ui manager");
        EditorGUILayout.LabelField("-set up cinimachine?");
        EditorGUILayout.Space();
        if (GUILayout.Button("5. configure and add ui manaager"))
        {
        ...
        EditorGUILayout.Space();
        if (GUILayout.Button("7. polish and deploy"))
        {
